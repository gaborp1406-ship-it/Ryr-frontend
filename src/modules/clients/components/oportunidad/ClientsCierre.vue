    ...
    <div v-if="cargando" class="bg-white border border-slate-200 rounded-2xl shadow-sm p-8">
      <div class="flex flex-col items-center justify-center gap-4 py-12">
        <div class="relative w-12 h-12">
          ...
          <div class="absolute inset-0 rounded-full border-4 border-transparent border-t-[#2d8c4a] border-r-[#2d8c4a] animate-spin"></div>
        </div>
      ...
      <div v-if="actualizando"
        ...
        <div class="flex flex-col items-center gap-2">
          <div class="relative w-8 h-8">
            ...
            <div class="absolute inset-0 rounded-full border-2 border-transparent border-t-[#2d8c4a] animate-spin"></div>
          </div>
      ...
      <div class="px-6 py-6">
        ...
        <div v-if="mostrarAcciones" class="mt-5 pt-5 border-t border-slate-100">
          <div class="flex flex-wrap gap-2 sm:justify-end">
            ...
            <button @click="marcarRealizado" :disabled="actualizando"
